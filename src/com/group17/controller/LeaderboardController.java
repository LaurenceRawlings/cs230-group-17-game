...
import com.group17.core.Leaderboard;
import com.group17.core.LevelReader;
...
public class LeaderboardController {
    ...
    void initialize() {
        ...
        timer = new Timeline(new KeyFrame(Duration.seconds(30), event -> lbl_motd.setText(MOTD.get())));
